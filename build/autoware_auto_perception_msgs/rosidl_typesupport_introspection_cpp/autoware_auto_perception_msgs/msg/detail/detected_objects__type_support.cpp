...
{
  const auto & item = *reinterpret_cast<const autoware_auto_perception_msgs::msg::DetectedObject *>(
    get_const_function__DetectedObjects__objects(untyped_member, index));
  auto & value = *reinterpret_cast<autoware_auto_perception_msgs::msg::DetectedObject *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<autoware_auto_perception_msgs::msg::DetectedObject *>(
    get_function__DetectedObjects__objects(untyped_member, index));
  const auto & value = *reinterpret_cast<const autoware_auto_perception_msgs::msg::DetectedObject *>(untyped_value);
  item = value;
}
