...
{
  const auto & item = *reinterpret_cast<const autoware_auto_perception_msgs::msg::BoundingBox *>(
    get_const_function__BoundingBoxArray__boxes(untyped_member, index));
  auto & value = *reinterpret_cast<autoware_auto_perception_msgs::msg::BoundingBox *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<autoware_auto_perception_msgs::msg::BoundingBox *>(
    get_function__BoundingBoxArray__boxes(untyped_member, index));
  const auto & value = *reinterpret_cast<const autoware_auto_perception_msgs::msg::BoundingBox *>(untyped_value);
  item = value;
}
