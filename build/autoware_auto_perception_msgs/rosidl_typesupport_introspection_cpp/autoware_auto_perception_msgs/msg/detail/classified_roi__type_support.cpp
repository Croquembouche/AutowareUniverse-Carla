...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ClassifiedRoi_message_member_array[2] = {
  {
    ...
    fetch_function__ClassifiedRoi__classifications,  // fetch(index, &value) function pointer
    assign_function__ClassifiedRoi__classifications,  // assign(index, value) function pointer
