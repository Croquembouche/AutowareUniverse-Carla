...
bool autoware_auto_perception_msgs__msg__detected_object__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("autoware_auto_perception_msgs.msg._detected_object.DetectedObject", full_classname_dest, 65) == 0);
  }
  autoware_auto_perception_msgs__msg__DetectedObject * ros_message = _ros_message;
  ...
  {  // kinematics
    ...
    if (!autoware_auto_perception_msgs__msg__detected_object_kinematics__convert_from_py(field, &ros_message->kinematics)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * autoware_auto_perception_msgs__msg__detected_object__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("autoware_auto_perception_msgs.msg._detected_object");
  ...
  {  // kinematics
    PyObject * field = NULL;
    field = autoware_auto_perception_msgs__msg__detected_object_kinematics__convert_to_py(&ros_message->kinematics);
    if (!field) {
      return NULL;
    }
    {
