...
static const _HADMapSegment_type_support_symbol_names_t _HADMapSegment_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_auto_mapping_msgs, msg, HADMapSegment)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autoware_auto_mapping_msgs, msg, HADMapSegment)),
  }
};
...
{
  return &::autoware_auto_mapping_msgs::msg::rosidl_typesupport_cpp::HADMapSegment_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, autoware_auto_mapping_msgs, msg, HADMapSegment)() {
  return get_message_type_support_handle<autoware_auto_mapping_msgs::msg::HADMapSegment>();
}
