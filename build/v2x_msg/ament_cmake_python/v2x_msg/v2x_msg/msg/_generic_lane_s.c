...
bool v2x_msg__msg__generic_lane__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("v2x_msg.msg._generic_lane.GenericLane", full_classname_dest, 37) == 0);
  }
  v2x_msg__msg__GenericLane * ros_message = _ros_message;
  {  // laneid
  ...
  {  // ingressapproach
    PyObject * field = PyObject_GetAttrString(_pymsg, "ingressapproach");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->ingressapproach = PyLong_AsLongLong(field);
    Py_DECREF(field);
  }
  {  // egressapproach
    PyObject * field = PyObject_GetAttrString(_pymsg, "egressapproach");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
  ...
  {  // nodelist
    ...
    PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'nodelist'");
    if (!seq_field) {
      Py_DECREF(field);
      return false;
    }
    ...
    if (!v2x_msg__msg__NodeListXY__Sequence__init(&(ros_message->nodelist), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create v2x_msg__msg__NodeListXY__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    v2x_msg__msg__NodeListXY * dest = ros_message->nodelist.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!v2x_msg__msg__node_list_xy__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // connectsto
    PyObject * field = PyObject_GetAttrString(_pymsg, "connectsto");
    if (!field) {
      return false;
    }
    PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'connectsto'");
    if (!seq_field) {
      Py_DECREF(field);
      return false;
    }
    ...
    if (!v2x_msg__msg__Connection__Sequence__init(&(ros_message->connectsto), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create v2x_msg__msg__Connection__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    v2x_msg__msg__Connection * dest = ros_message->connectsto.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!v2x_msg__msg__connection__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // overlays
    PyObject * field = PyObject_GetAttrString(_pymsg, "overlays");
    if (!field) {
      return false;
    }
    if (PyObject_CheckBuffer(field)) {
      ...
      int64_t * dest = ros_message->overlays.data;
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'overlays'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
...
PyObject * v2x_msg__msg__generic_lane__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("v2x_msg.msg._generic_lane");
  ...
  {  // ingressapproach
    PyObject * field = NULL;
    field = PyLong_FromLongLong(ros_message->ingressapproach);
    {
      int rc = PyObject_SetAttrString(_pymessage, "ingressapproach", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // egressapproach
    PyObject * field = NULL;
    field = PyLong_FromLongLong(ros_message->egressapproach);
    {
      int rc = PyObject_SetAttrString(_pymessage, "egressapproach", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // nodelist
    ...
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->nodelist.data[i]);
      PyObject * pyitem = v2x_msg__msg__node_list_xy__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
  ...
  {  // connectsto
    ...
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->connectsto.data[i]);
      PyObject * pyitem = v2x_msg__msg__connection__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
    ...
    assert(PySequence_Check(field));
    {
      int rc = PyObject_SetAttrString(_pymessage, "connectsto", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // overlays
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "overlays");
    if (!field) {
      return NULL;
    }
    ...
    if (ros_message->overlays.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      int64_t * src = &(ros_message->overlays.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->overlays.size * sizeof(int64_t));
      assert(data != NULL);
