...
bool v2x_msg__msg__speedand_headingand_throttle_confidence__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("v2x_msg.msg._speedand_headingand_throttle_confidence.SpeedandHeadingandThrottleConfidence", full_classname_dest, 89) == 0);
  }
  v2x_msg__msg__SpeedandHeadingandThrottleConfidence * ros_message = _ros_message;
  {  // heading
...
{
  /* NOTE(esteve): Call constructor of SpeedandHeadingandThrottleConfidence */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("v2x_msg.msg._speedand_headingand_throttle_confidence");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SpeedandHeadingandThrottleConfidence");
