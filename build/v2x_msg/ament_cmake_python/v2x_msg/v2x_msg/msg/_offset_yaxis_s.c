...
bool v2x_msg__msg__offset_yaxis__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("v2x_msg.msg._offset_yaxis.OffsetYaxis", full_classname_dest, 37) == 0);
  }
  v2x_msg__msg__OffsetYaxis * ros_message = _ros_message;
  {  // small
...
PyObject * v2x_msg__msg__offset_yaxis__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("v2x_msg.msg._offset_yaxis");
