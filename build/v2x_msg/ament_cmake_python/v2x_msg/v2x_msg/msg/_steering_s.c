...
bool v2x_msg__msg__steering__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("v2x_msg.msg._steering.Steering", full_classname_dest, 30) == 0);
  }
  v2x_msg__msg__Steering * ros_message = _ros_message;
  {  // angle
  ...
  {  // wheel
    ...
    assert(PyLong_Check(field));
    ros_message->wheel = PyLong_AsLongLong(field);
    Py_DECREF(field);
  }
...
PyObject * v2x_msg__msg__steering__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("v2x_msg.msg._steering");
  ...
  {  // wheel
    PyObject * field = NULL;
    field = PyLong_FromLongLong(ros_message->wheel);
    {
