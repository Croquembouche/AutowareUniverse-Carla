...
class BSM(metaclass=Metaclass_BSM):
    ...
    def __init__(self, **kwargs):
        ...
        from v2x_msg.msg import BSMCoreData
        self.coredata = kwargs.get('coredata', BSMCoreData())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.coredata != other.coredata:
            return False
        return True
    ...
    @coredata.setter
    def coredata(self, value):
        if __debug__:
            from v2x_msg.msg import BSMCoreData
            assert \
                isinstance(value, BSMCoreData), \
                "The 'coredata' field must be a sub message of type 'BSMCoreData'"
        self._coredata = value
