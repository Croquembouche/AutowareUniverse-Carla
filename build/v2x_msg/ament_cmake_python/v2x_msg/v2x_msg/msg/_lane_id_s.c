...
bool v2x_msg__msg__lane_id__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("v2x_msg.msg._lane_id.LaneID", full_classname_dest, 27) == 0);
  }
  v2x_msg__msg__LaneID * ros_message = _ros_message;
  {  // id
...
PyObject * v2x_msg__msg__lane_id__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("v2x_msg.msg._lane_id");
