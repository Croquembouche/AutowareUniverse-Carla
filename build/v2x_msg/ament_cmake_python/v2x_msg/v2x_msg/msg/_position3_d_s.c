...
bool v2x_msg__msg__position3_d__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("v2x_msg.msg._position3_d.Position3D", full_classname_dest, 35) == 0);
  }
  v2x_msg__msg__Position3D * ros_message = _ros_message;
  {  // latitude
...
{
  /* NOTE(esteve): Call constructor of Position3D */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("v2x_msg.msg._position3_d");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Position3D");
