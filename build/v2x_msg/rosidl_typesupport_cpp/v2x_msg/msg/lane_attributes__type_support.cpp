...
static const _LaneAttributes_type_support_symbol_names_t _LaneAttributes_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, v2x_msg, msg, LaneAttributes)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, v2x_msg, msg, LaneAttributes)),
  }
};
...
{
  return &::v2x_msg::msg::rosidl_typesupport_cpp::LaneAttributes_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, v2x_msg, msg, LaneAttributes)() {
  return get_message_type_support_handle<v2x_msg::msg::LaneAttributes>();
}
