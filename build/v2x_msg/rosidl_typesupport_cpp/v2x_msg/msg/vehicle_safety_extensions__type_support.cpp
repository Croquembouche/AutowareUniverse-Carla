...
static const _VehicleSafetyExtensions_type_support_symbol_names_t _VehicleSafetyExtensions_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, v2x_msg, msg, VehicleSafetyExtensions)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, v2x_msg, msg, VehicleSafetyExtensions)),
  }
};
...
{
  return &::v2x_msg::msg::rosidl_typesupport_cpp::VehicleSafetyExtensions_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, v2x_msg, msg, VehicleSafetyExtensions)() {
  return get_message_type_support_handle<v2x_msg::msg::VehicleSafetyExtensions>();
}
