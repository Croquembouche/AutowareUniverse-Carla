...
static rosidl_typesupport_introspection_c__MessageMember v2x_msg__msg__Object__rosidl_typesupport_introspection_c__Object_message_member_array[3] = {
  {
    ...
    offsetof(v2x_msg__msg__Object, obdist),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(v2x_msg__msg__Object, obdirect),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(v2x_msg__msg__Object, datetime),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
