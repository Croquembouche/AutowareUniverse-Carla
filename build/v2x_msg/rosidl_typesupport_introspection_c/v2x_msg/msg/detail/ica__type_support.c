...
void ICA__rosidl_typesupport_introspection_c__ICA_init_function(
...
void ICA__rosidl_typesupport_introspection_c__ICA_fini_function(void * message_memory)
{
  v2x_msg__msg__ICA__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember ICA__rosidl_typesupport_introspection_c__ICA_message_member_array[9] = {
  {
    "msgcnt",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers ICA__rosidl_typesupport_introspection_c__ICA_message_members = {
  "v2x_msg__msg",  // message namespace
  "ICA",  // message name
  9,  // number of fields
  sizeof(v2x_msg__msg__ICA),
  ICA__rosidl_typesupport_introspection_c__ICA_message_member_array,  // message members
  ICA__rosidl_typesupport_introspection_c__ICA_init_function,  // function to initialize message memory (memory has to be allocated)
  ICA__rosidl_typesupport_introspection_c__ICA_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t ICA__rosidl_typesupport_introspection_c__ICA_message_type_support_handle = {
  0,
  &ICA__rosidl_typesupport_introspection_c__ICA_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, v2x_msg, msg, ICA)() {
  ICA__rosidl_typesupport_introspection_c__ICA_message_member_array[3].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, v2x_msg, msg, BSMCoreData)();
  ICA__rosidl_typesupport_introspection_c__ICA_message_member_array[4].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, v2x_msg, msg, PathHistory)();
  ICA__rosidl_typesupport_introspection_c__ICA_message_member_array[5].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, v2x_msg, msg, PathPrediction)();
  ICA__rosidl_typesupport_introspection_c__ICA_message_member_array[6].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, v2x_msg, msg, IntersectionReferenceID)();
  ICA__rosidl_typesupport_introspection_c__ICA_message_member_array[7].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, v2x_msg, msg, ApproachOrLane)();
  if (!ICA__rosidl_typesupport_introspection_c__ICA_message_type_support_handle.typesupport_identifier) {
    ICA__rosidl_typesupport_introspection_c__ICA_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &ICA__rosidl_typesupport_introspection_c__ICA_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
