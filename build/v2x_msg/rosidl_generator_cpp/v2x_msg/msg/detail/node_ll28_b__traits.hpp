...
template<>
inline const char * data_type<v2x_msg::msg::NodeLL28B>()
{
  return "v2x_msg::msg::NodeLL28B";
}

template<>
inline const char * name<v2x_msg::msg::NodeLL28B>()
{
  return "v2x_msg/msg/NodeLL28B";
}

template<>
struct has_fixed_size<v2x_msg::msg::NodeLL28B>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<v2x_msg::msg::NodeLL28B>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<v2x_msg::msg::NodeLL28B>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // V2X_MSG__MSG__DETAIL__NODE_LL28_B__TRAITS_HPP_
