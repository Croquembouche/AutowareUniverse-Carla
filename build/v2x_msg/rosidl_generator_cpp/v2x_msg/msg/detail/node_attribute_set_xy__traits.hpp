...
template<>
inline const char * data_type<v2x_msg::msg::NodeAttributeSetXY>()
{
  return "v2x_msg::msg::NodeAttributeSetXY";
}

template<>
inline const char * name<v2x_msg::msg::NodeAttributeSetXY>()
{
  return "v2x_msg/msg/NodeAttributeSetXY";
}

template<>
struct has_fixed_size<v2x_msg::msg::NodeAttributeSetXY>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<v2x_msg::msg::NodeAttributeSetXY>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<v2x_msg::msg::NodeAttributeSetXY>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // V2X_MSG__MSG__DETAIL__NODE_ATTRIBUTE_SET_XY__TRAITS_HPP_
