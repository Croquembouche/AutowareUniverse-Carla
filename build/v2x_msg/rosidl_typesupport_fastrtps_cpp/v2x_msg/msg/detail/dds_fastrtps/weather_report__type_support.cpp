...
#include "v2x_msg/msg/detail/weather_report__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const v2x_msg::msg::WeatherReport & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  v2x_msg::msg::WeatherReport & ros_message)
{
  // Member: israining
  cdr >> ros_message.israining;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = v2x_msg::msg::WeatherReport;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const v2x_msg::msg::WeatherReport *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<v2x_msg::msg::WeatherReport *>(
    untyped_ros_message);
...
static size_t _WeatherReport__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_WeatherReport(full_bounded, is_plain, 0);
...
{
  return &v2x_msg::msg::typesupport_fastrtps_cpp::_WeatherReport__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, v2x_msg, msg, WeatherReport)() {
  return &v2x_msg::msg::typesupport_fastrtps_cpp::_WeatherReport__handle;
}
