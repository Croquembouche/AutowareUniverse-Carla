...
#include "v2x_msg/msg/detail/object__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const v2x_msg::msg::Object & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  v2x_msg::msg::Object & ros_message)
{
  // Member: obdist
  cdr >> ros_message.obdist;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = v2x_msg::msg::Object;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const v2x_msg::msg::Object *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<v2x_msg::msg::Object *>(
    untyped_ros_message);
...
{
  return &v2x_msg::msg::typesupport_fastrtps_cpp::_Object__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, v2x_msg, msg, Object)() {
  return &v2x_msg::msg::typesupport_fastrtps_cpp::_Object__handle;
}
