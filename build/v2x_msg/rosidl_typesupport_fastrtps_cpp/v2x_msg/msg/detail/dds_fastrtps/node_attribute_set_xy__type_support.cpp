...
#include "v2x_msg/msg/detail/node_attribute_set_xy__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const v2x_msg::msg::NodeAttributeSetXY & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  v2x_msg::msg::NodeAttributeSetXY & ros_message)
{
  // Member: localnode
  {
    cdr >> ros_message.localnode;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = v2x_msg::msg::NodeAttributeSetXY;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const v2x_msg::msg::NodeAttributeSetXY *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<v2x_msg::msg::NodeAttributeSetXY *>(
    untyped_ros_message);
...
static size_t _NodeAttributeSetXY__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_NodeAttributeSetXY(full_bounded, is_plain, 0);
...
{
  return &v2x_msg::msg::typesupport_fastrtps_cpp::_NodeAttributeSetXY__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, v2x_msg, msg, NodeAttributeSetXY)() {
  return &v2x_msg::msg::typesupport_fastrtps_cpp::_NodeAttributeSetXY__handle;
}
