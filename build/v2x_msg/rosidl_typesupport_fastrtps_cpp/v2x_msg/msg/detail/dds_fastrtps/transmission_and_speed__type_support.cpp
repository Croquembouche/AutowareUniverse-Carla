...
#include "v2x_msg/msg/detail/transmission_and_speed__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const v2x_msg::msg::TransmissionAndSpeed & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  v2x_msg::msg::TransmissionAndSpeed & ros_message)
{
  // Member: transmission
  cdr >> ros_message.transmission;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = v2x_msg::msg::TransmissionAndSpeed;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const v2x_msg::msg::TransmissionAndSpeed *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<v2x_msg::msg::TransmissionAndSpeed *>(
    untyped_ros_message);
...
static size_t _TransmissionAndSpeed__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TransmissionAndSpeed(full_bounded, is_plain, 0);
...
{
  return &v2x_msg::msg::typesupport_fastrtps_cpp::_TransmissionAndSpeed__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, v2x_msg, msg, TransmissionAndSpeed)() {
  return &v2x_msg::msg::typesupport_fastrtps_cpp::_TransmissionAndSpeed__handle;
}
