...
#include "v2x_msg/msg/detail/offset_xaxis__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const v2x_msg::msg::OffsetXaxis & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  v2x_msg::msg::OffsetXaxis & ros_message)
{
  // Member: small
  cdr >> ros_message.small;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = v2x_msg::msg::OffsetXaxis;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const v2x_msg::msg::OffsetXaxis *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<v2x_msg::msg::OffsetXaxis *>(
    untyped_ros_message);
...
static size_t _OffsetXaxis__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_OffsetXaxis(full_bounded, is_plain, 0);
...
{
  return &v2x_msg::msg::typesupport_fastrtps_cpp::_OffsetXaxis__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, v2x_msg, msg, OffsetXaxis)() {
  return &v2x_msg::msg::typesupport_fastrtps_cpp::_OffsetXaxis__handle;
}
