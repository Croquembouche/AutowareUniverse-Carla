...
#include "v2x_msg/msg/detail/brake_system_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const v2x_msg::msg::BrakeSystemStatus & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: wheelbrakes
  cdr << ros_message.wheelbrakes;
  // Member: traction
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  v2x_msg::msg::BrakeSystemStatus & ros_message)
{
  // Member: wheelbrakes
  cdr >> ros_message.wheelbrakes;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = v2x_msg::msg::BrakeSystemStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const v2x_msg::msg::BrakeSystemStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<v2x_msg::msg::BrakeSystemStatus *>(
    untyped_ros_message);
...
static size_t _BrakeSystemStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_BrakeSystemStatus(full_bounded, is_plain, 0);
...
{
  return &v2x_msg::msg::typesupport_fastrtps_cpp::_BrakeSystemStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, v2x_msg, msg, BrakeSystemStatus)() {
  return &v2x_msg::msg::typesupport_fastrtps_cpp::_BrakeSystemStatus__handle;
}
