...
#include "v2x_msg/msg/detail/steering__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const v2x_msg::msg::Steering & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  v2x_msg::msg::Steering & ros_message)
{
  // Member: angle
  cdr >> ros_message.angle;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = v2x_msg::msg::Steering;
    is_plain =
      (
      offsetof(DataType, wheel) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const v2x_msg::msg::Steering *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<v2x_msg::msg::Steering *>(
    untyped_ros_message);
...
{
  return &v2x_msg::msg::typesupport_fastrtps_cpp::_Steering__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, v2x_msg, msg, Steering)() {
  return &v2x_msg::msg::typesupport_fastrtps_cpp::_Steering__handle;
}
