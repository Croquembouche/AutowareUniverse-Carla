...
#include "v2x_msg/msg/detail/signal_status_package__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const v2x_msg::msg::SignalRequesterInfo &,
...
// functions for v2x_msg::msg::IntersectionAccessPoint already declared above
...
cdr_serialize(
  const v2x_msg::msg::SignalStatusPackage & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: inboundon
  v2x_msg::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.inboundon,
    cdr);
  // Member: outboundon
  v2x_msg::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.outboundon,
    cdr);
  // Member: minute
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  v2x_msg::msg::SignalStatusPackage & ros_message)
{
  // Member: requester
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_v2x_msg
max_serialized_size_SignalStatusPackage(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: requester
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        v2x_msg::msg::typesupport_fastrtps_cpp::max_serialized_size_SignalRequesterInfo(
  ...
  if (is_plain) {
    ...
    using DataType = v2x_msg::msg::SignalStatusPackage;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const v2x_msg::msg::SignalStatusPackage *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<v2x_msg::msg::SignalStatusPackage *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SignalStatusPackage__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const v2x_msg::msg::SignalStatusPackage *>(
...
static size_t _SignalStatusPackage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SignalStatusPackage(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SignalStatusPackage__callbacks = {
  "v2x_msg::msg",
  "SignalStatusPackage",
...
static rosidl_message_type_support_t _SignalStatusPackage__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SignalStatusPackage__callbacks,
...
{
  return &v2x_msg::msg::typesupport_fastrtps_cpp::_SignalStatusPackage__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, v2x_msg, msg, SignalStatusPackage)() {
  return &v2x_msg::msg::typesupport_fastrtps_cpp::_SignalStatusPackage__handle;
}
