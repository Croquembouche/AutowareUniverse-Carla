...
#include "v2x_msg/msg/detail/intersection_geometry__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const v2x_msg::msg::IntersectionGeometry & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: laneset
  {
    ...
    for (size_t i = 0; i < size; i++) {
      v2x_msg::msg::typesupport_fastrtps_cpp::cdr_serialize(
        ros_message.laneset[i],
        cdr);
    }
  }
  // Member: preemptprioritydata
  cdr << ros_message.preemptprioritydata;
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  v2x_msg::msg::IntersectionGeometry & ros_message)
{
  // Member: name
  cdr >> ros_message.name;
  ...
  // Member: laneset
  {
    ...
    cdr >> cdrSize;
    size_t size = static_cast<size_t>(cdrSize);
    ros_message.laneset.resize(size);
    for (size_t i = 0; i < size; i++) {
      v2x_msg::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.laneset[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: laneset
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        v2x_msg::msg::typesupport_fastrtps_cpp::get_serialized_size(
        ros_message.laneset[index], current_alignment);
    }
  }
  // Member: preemptprioritydata
  current_alignment += padding +
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = v2x_msg::msg::IntersectionGeometry;
    is_plain =
      (
      offsetof(DataType, preemptprioritydata) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const v2x_msg::msg::IntersectionGeometry *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<v2x_msg::msg::IntersectionGeometry *>(
    untyped_ros_message);
...
{
  return &v2x_msg::msg::typesupport_fastrtps_cpp::_IntersectionGeometry__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, v2x_msg, msg, IntersectionGeometry)() {
  return &v2x_msg::msg::typesupport_fastrtps_cpp::_IntersectionGeometry__handle;
}
