...
#include "v2x_msg/msg/detail/vehicle_ident__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const v2x_msg::msg::VehicleClass &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const v2x_msg::msg::VehicleIdent & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  v2x_msg::msg::VehicleIdent & ros_message)
{
  // Member: name
  cdr >> ros_message.name;
  ...
  size_t current_alignment)
{
  ...
  // Member: vehicleclass
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        v2x_msg::msg::typesupport_fastrtps_cpp::max_serialized_size_VehicleClass(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = v2x_msg::msg::VehicleIdent;
    is_plain =
      (
      offsetof(DataType, vehicleclass) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const v2x_msg::msg::VehicleIdent *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<v2x_msg::msg::VehicleIdent *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _VehicleIdent__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const v2x_msg::msg::VehicleIdent *>(
...
static size_t _VehicleIdent__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_VehicleIdent(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _VehicleIdent__callbacks = {
  "v2x_msg::msg",
  "VehicleIdent",
...
static rosidl_message_type_support_t _VehicleIdent__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_VehicleIdent__callbacks,
...
{
  return &v2x_msg::msg::typesupport_fastrtps_cpp::_VehicleIdent__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, v2x_msg, msg, VehicleIdent)() {
  return &v2x_msg::msg::typesupport_fastrtps_cpp::_VehicleIdent__handle;
}
