...
#include "v2x_msg/msg/detail/shape_point_set__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const v2x_msg::msg::ShapePointSet & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  v2x_msg::msg::ShapePointSet & ros_message)
{
  // Member: anchor
...
{
  auto typed_message =
    static_cast<const v2x_msg::msg::ShapePointSet *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<v2x_msg::msg::ShapePointSet *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ShapePointSet__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const v2x_msg::msg::ShapePointSet *>(
...
static size_t _ShapePointSet__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_ShapePointSet(full_bounded, 0);
}

static message_type_support_callbacks_t _ShapePointSet__callbacks = {
  "v2x_msg::msg",
  "ShapePointSet",
...
static rosidl_message_type_support_t _ShapePointSet__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ShapePointSet__callbacks,
...
{
  return &v2x_msg::msg::typesupport_fastrtps_cpp::_ShapePointSet__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, v2x_msg, msg, ShapePointSet)() {
  return &v2x_msg::msg::typesupport_fastrtps_cpp::_ShapePointSet__handle;
}
