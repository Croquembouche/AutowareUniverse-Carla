  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = v2x_msg::msg::RegionPointSet;
    is_plain =
      (
...
static size_t _RegionPointSet__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_RegionPointSet(full_bounded, is_plain, 0);
