...
#include "v2x_msg/msg/detail/vehicle_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const v2x_msg::msg::WeatherReport &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const v2x_msg::msg::VehicleStatus & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: speedheadc
  v2x_msg::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.speedheadc,
    cdr);
  // Member: speedc
  cdr << ros_message.speedc;
  // Member: vehicledata
  v2x_msg::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.vehicledata,
    cdr);
  // Member: vehicleident
  v2x_msg::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.vehicleident,
    cdr);
  // Member: j1939data
  v2x_msg::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.j1939data,
    cdr);
  // Member: weatherreport
  v2x_msg::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.weatherreport,
    cdr);
  // Member: gnssstatus
  cdr << ros_message.gnssstatus;
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  v2x_msg::msg::VehicleStatus & ros_message)
{
  // Member: lights
  cdr >> ros_message.lights;
  ...
  size_t current_alignment)
{
  ...
  // Member: wipers
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        v2x_msg::msg::typesupport_fastrtps_cpp::max_serialized_size_WiperSet(
  ...
  // Member: steering
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        v2x_msg::msg::typesupport_fastrtps_cpp::max_serialized_size_Steering(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: accelsets
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        v2x_msg::msg::typesupport_fastrtps_cpp::max_serialized_size_AccelSets(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: object
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        v2x_msg::msg::typesupport_fastrtps_cpp::max_serialized_size_Object(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: vehicledata
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        v2x_msg::msg::typesupport_fastrtps_cpp::max_serialized_size_VehicleData(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: j1939data
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        v2x_msg::msg::typesupport_fastrtps_cpp::max_serialized_size_J1939data(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: weatherreport
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        v2x_msg::msg::typesupport_fastrtps_cpp::max_serialized_size_WeatherReport(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = v2x_msg::msg::VehicleStatus;
    is_plain =
      (
      offsetof(DataType, gnssstatus) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const v2x_msg::msg::VehicleStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<v2x_msg::msg::VehicleStatus *>(
    untyped_ros_message);
...
{
  return &v2x_msg::msg::typesupport_fastrtps_cpp::_VehicleStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, v2x_msg, msg, VehicleStatus)() {
  return &v2x_msg::msg::typesupport_fastrtps_cpp::_VehicleStatus__handle;
}
