...
#include "v2x_msg/msg/detail/speed_limit__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const v2x_msg::msg::SpeedLimit & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  v2x_msg::msg::SpeedLimit & ros_message)
{
  // Member: type
  cdr >> ros_message.type;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = v2x_msg::msg::SpeedLimit;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const v2x_msg::msg::SpeedLimit *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<v2x_msg::msg::SpeedLimit *>(
    untyped_ros_message);
...
{
  return &v2x_msg::msg::typesupport_fastrtps_cpp::_SpeedLimit__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, v2x_msg, msg, SpeedLimit)() {
  return &v2x_msg::msg::typesupport_fastrtps_cpp::_SpeedLimit__handle;
}
