...
#include "v2x_msg/msg/detail/lane_data_attribute__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const v2x_msg::msg::LaneDataAttribute & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  v2x_msg::msg::LaneDataAttribute & ros_message)
{
  // Member: pathendpointangle
  cdr >> ros_message.pathendpointangle;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = v2x_msg::msg::LaneDataAttribute;
    is_plain =
      (
      offsetof(DataType, speedlimits) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const v2x_msg::msg::LaneDataAttribute *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<v2x_msg::msg::LaneDataAttribute *>(
    untyped_ros_message);
...
static size_t _LaneDataAttribute__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_LaneDataAttribute(full_bounded, is_plain, 0);
...
{
  return &v2x_msg::msg::typesupport_fastrtps_cpp::_LaneDataAttribute__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, v2x_msg, msg, LaneDataAttribute)() {
  return &v2x_msg::msg::typesupport_fastrtps_cpp::_LaneDataAttribute__handle;
}
