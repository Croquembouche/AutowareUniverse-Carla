...
#include "v2x_msg/msg/detail/vehicle_classification__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const v2x_msg::msg::VehicleClassification & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  v2x_msg::msg::VehicleClassification & ros_message)
{
  // Member: keytype
  cdr >> ros_message.keytype;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = v2x_msg::msg::VehicleClassification;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const v2x_msg::msg::VehicleClassification *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<v2x_msg::msg::VehicleClassification *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _VehicleClassification__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const v2x_msg::msg::VehicleClassification *>(
...
static size_t _VehicleClassification__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_VehicleClassification(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _VehicleClassification__callbacks = {
  "v2x_msg::msg",
...
static rosidl_message_type_support_t _VehicleClassification__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_VehicleClassification__callbacks,
...
{
  return &v2x_msg::msg::typesupport_fastrtps_cpp::_VehicleClassification__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, v2x_msg, msg, VehicleClassification)() {
  return &v2x_msg::msg::typesupport_fastrtps_cpp::_VehicleClassification__handle;
}
