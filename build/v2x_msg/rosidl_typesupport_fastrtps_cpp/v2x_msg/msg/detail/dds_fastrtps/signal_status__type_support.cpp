...
#include "v2x_msg/msg/detail/signal_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const v2x_msg::msg::SignalStatusPackage &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const v2x_msg::msg::SignalStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  v2x_msg::msg::SignalStatus & ros_message)
{
  // Member: sequencenumber
  cdr >> ros_message.sequencenumber;
  ...
  // Member: sigstatus
  {
    ...
    ros_message.sigstatus.resize(size);
    for (size_t i = 0; i < size; i++) {
      v2x_msg::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.sigstatus[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: sigstatus
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        v2x_msg::msg::typesupport_fastrtps_cpp::get_serialized_size(
        ros_message.sigstatus[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: sigstatus
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        v2x_msg::msg::typesupport_fastrtps_cpp::max_serialized_size_SignalStatusPackage(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = v2x_msg::msg::SignalStatus;
    is_plain =
      (
      offsetof(DataType, sigstatus) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const v2x_msg::msg::SignalStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<v2x_msg::msg::SignalStatus *>(
    untyped_ros_message);
...
{
  return &v2x_msg::msg::typesupport_fastrtps_cpp::_SignalStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, v2x_msg, msg, SignalStatus)() {
  return &v2x_msg::msg::typesupport_fastrtps_cpp::_SignalStatus__handle;
}
