...
#include "v2x_msg/msg/detail/offset__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const v2x_msg::msg::Offset & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  v2x_msg::msg::Offset & ros_message)
{
  // Member: xy
  ...
  size_t current_alignment)
{
  ...
  // Member: nodes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        v2x_msg::msg::typesupport_fastrtps_cpp::max_serialized_size_NodeLL(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = v2x_msg::msg::Offset;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const v2x_msg::msg::Offset *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<v2x_msg::msg::Offset *>(
    untyped_ros_message);
...
{
  return &v2x_msg::msg::typesupport_fastrtps_cpp::_Offset__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, v2x_msg, msg, Offset)() {
  return &v2x_msg::msg::typesupport_fastrtps_cpp::_Offset__handle;
}
