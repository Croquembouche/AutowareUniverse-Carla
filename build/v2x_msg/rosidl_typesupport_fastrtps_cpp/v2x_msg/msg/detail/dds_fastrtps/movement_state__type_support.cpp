...
#include "v2x_msg/msg/detail/movement_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const v2x_msg::msg::MovementEvent &,
...
cdr_serialize(
  const v2x_msg::msg::MovementState & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: movementname
  cdr << ros_message.movementname;
  ...
  // Member: statetimespeed
  {
    ...
    for (size_t i = 0; i < size; i++) {
      v2x_msg::msg::typesupport_fastrtps_cpp::cdr_serialize(
        ros_message.statetimespeed[i],
        cdr);
    }
  }
  // Member: maneuverassistlist
  v2x_msg::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.maneuverassistlist,
    cdr);
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  v2x_msg::msg::MovementState & ros_message)
{
  // Member: movementname
  cdr >> ros_message.movementname;
  ...
  // Member: statetimespeed
  {
    ...
    ros_message.statetimespeed.resize(size);
    for (size_t i = 0; i < size; i++) {
      v2x_msg::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.statetimespeed[i]);
    }
  }
  ...
  // Member: statetimespeed
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.statetimespeed[index], current_alignment);
    }
  }
  // Member: maneuverassistlist
  ...
  size_t current_alignment)
{
  ...
  // Member: statetimespeed
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        v2x_msg::msg::typesupport_fastrtps_cpp::max_serialized_size_MovementEvent(
  ...
  if (is_plain) {
    ...
    using DataType = v2x_msg::msg::MovementState;
    is_plain =
      (
      offsetof(DataType, maneuverassistlist) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const v2x_msg::msg::MovementState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<v2x_msg::msg::MovementState *>(
    untyped_ros_message);
...
{
  return &v2x_msg::msg::typesupport_fastrtps_cpp::_MovementState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, v2x_msg, msg, MovementState)() {
  return &v2x_msg::msg::typesupport_fastrtps_cpp::_MovementState__handle;
}
