...
#include "v2x_msg/msg/detail/road_segment_reference_id__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const v2x_msg::msg::RoadSegmentReferenceID & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  v2x_msg::msg::RoadSegmentReferenceID & ros_message)
{
  // Member: roadregulatorid
  cdr >> ros_message.roadregulatorid;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = v2x_msg::msg::RoadSegmentReferenceID;
    is_plain =
      (
      offsetof(DataType, roadsegmentid) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const v2x_msg::msg::RoadSegmentReferenceID *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<v2x_msg::msg::RoadSegmentReferenceID *>(
    untyped_ros_message);
...
static size_t _RoadSegmentReferenceID__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_RoadSegmentReferenceID(full_bounded, is_plain, 0);
...
{
  return &v2x_msg::msg::typesupport_fastrtps_cpp::_RoadSegmentReferenceID__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, v2x_msg, msg, RoadSegmentReferenceID)() {
  return &v2x_msg::msg::typesupport_fastrtps_cpp::_RoadSegmentReferenceID__handle;
}
