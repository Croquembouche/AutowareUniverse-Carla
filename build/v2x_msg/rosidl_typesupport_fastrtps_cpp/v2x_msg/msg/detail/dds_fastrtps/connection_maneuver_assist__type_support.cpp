...
#include "v2x_msg/msg/detail/connection_maneuver_assist__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const v2x_msg::msg::ConnectionManeuverAssist & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  v2x_msg::msg::ConnectionManeuverAssist & ros_message)
{
  // Member: connectionid
  cdr >> ros_message.connectionid;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = v2x_msg::msg::ConnectionManeuverAssist;
    is_plain =
      (
      offsetof(DataType, pedbicycledetect) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const v2x_msg::msg::ConnectionManeuverAssist *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<v2x_msg::msg::ConnectionManeuverAssist *>(
    untyped_ros_message);
...
static size_t _ConnectionManeuverAssist__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_ConnectionManeuverAssist(full_bounded, is_plain, 0);
...
{
  return &v2x_msg::msg::typesupport_fastrtps_cpp::_ConnectionManeuverAssist__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, v2x_msg, msg, ConnectionManeuverAssist)() {
  return &v2x_msg::msg::typesupport_fastrtps_cpp::_ConnectionManeuverAssist__handle;
}
