...
class PathPrediction(metaclass=Metaclass_PathPrediction):
    ...
    def __init__(self, **kwargs):
        ...
        self.radiusofcurve = kwargs.get('radiusofcurve', int())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.radiusofcurve != other.radiusofcurve:
            return False
    ...
    @builtins.property
    def radiusofcurve(self):
        """Message field 'radiusofcurve'."""
        return self._radiusofcurve

    @radiusofcurve.setter
    def radiusofcurve(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'radiusofcurve' field must be of type 'int'"
            assert value >= -9223372036854775808 and value < 9223372036854775808, \
                "The 'radiusofcurve' field must be an integer in [-9223372036854775808, 9223372036854775807]"
        self._radiusofcurve = value
