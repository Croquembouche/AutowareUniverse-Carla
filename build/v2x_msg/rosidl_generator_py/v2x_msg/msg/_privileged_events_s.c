...
bool v2x_msg__msg__privileged_events__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("v2x_msg.msg._privileged_events.PrivilegedEvents", full_classname_dest, 47) == 0);
  }
  v2x_msg__msg__PrivilegedEvents * ros_message = _ros_message;
  {  // notused
...
{
  /* NOTE(esteve): Call constructor of PrivilegedEvents */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("v2x_msg.msg._privileged_events");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PrivilegedEvents");
