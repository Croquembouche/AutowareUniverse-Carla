...
class RoadSegment(metaclass=Metaclass_RoadSegment):
    ...
    _fields_and_field_types = {
        ...
        'roadlaneset': 'sequence<v2x_msg/GenericLane>',
    }
    ...
    def __init__(self, **kwargs):
        ...
        self.roadlaneset = kwargs.get('roadlaneset', [])
    ...
    def __eq__(self, other):
        ...
        if self.speedlimits != other.speedlimits:
            return False
        if self.roadlaneset != other.roadlaneset:
            return False
        return True
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'roadlaneset' field must be a set or sequence and each value of type 'GenericLane'"
        self._roadlaneset = value
