...
bool v2x_msg__msg__advisory_speed__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("v2x_msg.msg._advisory_speed.AdvisorySpeed", full_classname_dest, 41) == 0);
  }
  v2x_msg__msg__AdvisorySpeed * ros_message = _ros_message;
  {  // type
  ...
  {  // zonelength
    PyObject * field = PyObject_GetAttrString(_pymsg, "zonelength");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->zonelength = PyLong_AsLongLong(field);
    Py_DECREF(field);
  }
  {  // restrictionclassid
...
PyObject * v2x_msg__msg__advisory_speed__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("v2x_msg.msg._advisory_speed");
  ...
  {  // zonelength
    PyObject * field = NULL;
    field = PyLong_FromLongLong(ros_message->zonelength);
    {
      int rc = PyObject_SetAttrString(_pymessage, "zonelength", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
