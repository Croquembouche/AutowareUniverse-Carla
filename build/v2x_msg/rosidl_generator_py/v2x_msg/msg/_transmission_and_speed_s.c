...
bool v2x_msg__msg__transmission_and_speed__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("v2x_msg.msg._transmission_and_speed.TransmissionAndSpeed", full_classname_dest, 56) == 0);
  }
  v2x_msg__msg__TransmissionAndSpeed * ros_message = _ros_message;
  {  // transmission
...
PyObject * v2x_msg__msg__transmission_and_speed__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("v2x_msg.msg._transmission_and_speed");
