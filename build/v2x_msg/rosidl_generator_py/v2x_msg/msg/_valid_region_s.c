...
bool v2x_msg__msg__valid_region__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("v2x_msg.msg._valid_region.ValidRegion", full_classname_dest, 37) == 0);
  }
  v2x_msg__msg__ValidRegion * ros_message = _ros_message;
  {  // direction
  ...
  {  // area
    ...
    if (!v2x_msg__msg__area__convert_from_py(field, &ros_message->area)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of ValidRegion */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("v2x_msg.msg._valid_region");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ValidRegion");
  ...
  {  // area
    PyObject * field = NULL;
    field = v2x_msg__msg__area__convert_to_py(&ros_message->area);
    if (!field) {
      return NULL;
    }
    {
