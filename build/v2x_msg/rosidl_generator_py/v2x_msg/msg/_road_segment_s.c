...
bool v2x_msg__msg__road_segment__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("v2x_msg.msg._road_segment.RoadSegment", full_classname_dest, 37) == 0);
  }
  v2x_msg__msg__RoadSegment * ros_message = _ros_message;
  {  // name
  ...
  {  // roadlaneset
    PyObject * field = PyObject_GetAttrString(_pymsg, "roadlaneset");
    if (!field) {
      return false;
    }
    PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'roadlaneset'");
    if (!seq_field) {
      Py_DECREF(field);
      return false;
    }
    ...
    v2x_msg__msg__GenericLane * dest = ros_message->roadlaneset.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
...
PyObject * v2x_msg__msg__road_segment__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("v2x_msg.msg._road_segment");
  ...
  {  // roadlaneset
    ...
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->roadlaneset.data[i]);
    ...
    assert(PySequence_Check(field));
    {
      int rc = PyObject_SetAttrString(_pymessage, "roadlaneset", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
