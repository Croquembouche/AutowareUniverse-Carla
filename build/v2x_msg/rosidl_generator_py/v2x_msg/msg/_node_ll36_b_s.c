...
bool v2x_msg__msg__node_ll36_b__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("v2x_msg.msg._node_ll36_b.NodeLL36B", full_classname_dest, 34) == 0);
  }
  v2x_msg__msg__NodeLL36B * ros_message = _ros_message;
  {  // lon
...
{
  /* NOTE(esteve): Call constructor of NodeLL36B */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("v2x_msg.msg._node_ll36_b");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "NodeLL36B");
