...
bool v2x_msg__msg__approach_or_lane__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("v2x_msg.msg._approach_or_lane.ApproachOrLane", full_classname_dest, 44) == 0);
  }
  v2x_msg__msg__ApproachOrLane * ros_message = _ros_message;
  {  // approach
...
{
  /* NOTE(esteve): Call constructor of ApproachOrLane */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("v2x_msg.msg._approach_or_lane");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ApproachOrLane");
