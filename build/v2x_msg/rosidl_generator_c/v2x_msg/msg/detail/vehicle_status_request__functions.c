...
v2x_msg__msg__VehicleStatusRequest__create()
{
  ...
  v2x_msg__msg__VehicleStatusRequest * msg = (v2x_msg__msg__VehicleStatusRequest *)allocator.allocate(sizeof(v2x_msg__msg__VehicleStatusRequest), allocator.state);
  if (!msg) {
    return NULL;
  }
...
v2x_msg__msg__VehicleStatusRequest__Sequence__init(v2x_msg__msg__VehicleStatusRequest__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (v2x_msg__msg__VehicleStatusRequest *)allocator.zero_allocate(size, sizeof(v2x_msg__msg__VehicleStatusRequest), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  v2x_msg__msg__VehicleStatusRequest__Sequence * array = (v2x_msg__msg__VehicleStatusRequest__Sequence *)allocator.allocate(sizeof(v2x_msg__msg__VehicleStatusRequest__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  v2x_msg__msg__VehicleStatusRequest__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    v2x_msg__msg__VehicleStatusRequest * data =
      (v2x_msg__msg__VehicleStatusRequest *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!v2x_msg__msg__VehicleStatusRequest__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          v2x_msg__msg__VehicleStatusRequest__fini(&output->data[i]);
        }
        return false;
      }
    }
