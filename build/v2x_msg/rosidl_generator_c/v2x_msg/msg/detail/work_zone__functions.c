...
{
  v2x_msg__msg__WorkZone * msg = (v2x_msg__msg__WorkZone *)malloc(sizeof(v2x_msg__msg__WorkZone));
  if (!msg) {
    return NULL;
  }
...
v2x_msg__msg__WorkZone__Sequence__init(v2x_msg__msg__WorkZone__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (v2x_msg__msg__WorkZone *)calloc(size, sizeof(v2x_msg__msg__WorkZone));
    if (!data) {
      return false;
    }
...
{
  v2x_msg__msg__WorkZone__Sequence * array = (v2x_msg__msg__WorkZone__Sequence *)malloc(sizeof(v2x_msg__msg__WorkZone__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  v2x_msg__msg__WorkZone__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    v2x_msg__msg__WorkZone * data =
      (v2x_msg__msg__WorkZone *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!v2x_msg__msg__WorkZone__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          v2x_msg__msg__WorkZone__fini(&data[i]);
        }
        free(data);
        return false;
      }
