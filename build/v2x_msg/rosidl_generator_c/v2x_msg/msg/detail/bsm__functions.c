...
v2x_msg__msg__BSM__init(v2x_msg__msg__BSM * msg)
{
  ...
  // coredata
  if (!v2x_msg__msg__BSMCoreData__init(&msg->coredata)) {
    v2x_msg__msg__BSM__fini(msg);
    return false;
  }
  return true;
}
...
v2x_msg__msg__BSM__fini(v2x_msg__msg__BSM * msg)
{
  ...
  // coredata
  v2x_msg__msg__BSMCoreData__fini(&msg->coredata);
}
  ...
  v2x_msg__msg__BSM * output)
{
  ...
  if (!v2x_msg__msg__BSMCoreData__copy(
      &(input->coredata), &(output->coredata)))
  {
    return false;
  }
  return true;
...
v2x_msg__msg__BSM__create()
{
  ...
  v2x_msg__msg__BSM * msg = (v2x_msg__msg__BSM *)allocator.allocate(sizeof(v2x_msg__msg__BSM), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(v2x_msg__msg__BSM));
  bool success = v2x_msg__msg__BSM__init(msg);
  if (!success) {
...
v2x_msg__msg__BSM__Sequence__init(v2x_msg__msg__BSM__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  v2x_msg__msg__BSM * data = NULL;

  if (size) {
    data = (v2x_msg__msg__BSM *)allocator.zero_allocate(size, sizeof(v2x_msg__msg__BSM), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = v2x_msg__msg__BSM__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        v2x_msg__msg__BSM__fini(&data[i - 1]);
      }
...
v2x_msg__msg__BSM__Sequence__fini(v2x_msg__msg__BSM__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      v2x_msg__msg__BSM__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  v2x_msg__msg__BSM__Sequence * array = (v2x_msg__msg__BSM__Sequence *)allocator.allocate(sizeof(v2x_msg__msg__BSM__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = v2x_msg__msg__BSM__Sequence__init(array, size);
  if (!success) {
...
v2x_msg__msg__BSM__Sequence__destroy(v2x_msg__msg__BSM__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    v2x_msg__msg__BSM__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
v2x_msg__msg__BSM__Sequence__are_equal(const v2x_msg__msg__BSM__Sequence * lhs, const v2x_msg__msg__BSM__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!v2x_msg__msg__BSM__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  v2x_msg__msg__BSM__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(v2x_msg__msg__BSM);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    v2x_msg__msg__BSM * data =
      (v2x_msg__msg__BSM *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!v2x_msg__msg__BSM__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          v2x_msg__msg__BSM__fini(&output->data[i]);
        }
        return false;
      }
    }
