...
v2x_msg__msg__TravelerDataFrame__create()
{
  ...
  v2x_msg__msg__TravelerDataFrame * msg = (v2x_msg__msg__TravelerDataFrame *)allocator.allocate(sizeof(v2x_msg__msg__TravelerDataFrame), allocator.state);
  if (!msg) {
    return NULL;
  }
...
v2x_msg__msg__TravelerDataFrame__Sequence__init(v2x_msg__msg__TravelerDataFrame__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (v2x_msg__msg__TravelerDataFrame *)allocator.zero_allocate(size, sizeof(v2x_msg__msg__TravelerDataFrame), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  v2x_msg__msg__TravelerDataFrame__Sequence * array = (v2x_msg__msg__TravelerDataFrame__Sequence *)allocator.allocate(sizeof(v2x_msg__msg__TravelerDataFrame__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  v2x_msg__msg__TravelerDataFrame__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    v2x_msg__msg__TravelerDataFrame * data =
      (v2x_msg__msg__TravelerDataFrame *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!v2x_msg__msg__TravelerDataFrame__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          v2x_msg__msg__TravelerDataFrame__fini(&output->data[i]);
        }
        return false;
      }
    }
