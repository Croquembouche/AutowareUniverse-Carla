...
{
  v2x_msg__msg__Sample * msg = (v2x_msg__msg__Sample *)malloc(sizeof(v2x_msg__msg__Sample));
  if (!msg) {
    return NULL;
  }
...
v2x_msg__msg__Sample__Sequence__init(v2x_msg__msg__Sample__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (v2x_msg__msg__Sample *)calloc(size, sizeof(v2x_msg__msg__Sample));
    if (!data) {
      return false;
    }
...
{
  v2x_msg__msg__Sample__Sequence * array = (v2x_msg__msg__Sample__Sequence *)malloc(sizeof(v2x_msg__msg__Sample__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  v2x_msg__msg__Sample__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    v2x_msg__msg__Sample * data =
      (v2x_msg__msg__Sample *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!v2x_msg__msg__Sample__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          v2x_msg__msg__Sample__fini(&data[i]);
        }
        free(data);
        return false;
      }
