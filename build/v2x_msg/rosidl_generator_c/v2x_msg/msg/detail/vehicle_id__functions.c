...
{
  v2x_msg__msg__VehicleID * msg = (v2x_msg__msg__VehicleID *)malloc(sizeof(v2x_msg__msg__VehicleID));
  if (!msg) {
    return NULL;
  }
...
v2x_msg__msg__VehicleID__Sequence__init(v2x_msg__msg__VehicleID__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (v2x_msg__msg__VehicleID *)calloc(size, sizeof(v2x_msg__msg__VehicleID));
    if (!data) {
      return false;
    }
...
{
  v2x_msg__msg__VehicleID__Sequence * array = (v2x_msg__msg__VehicleID__Sequence *)malloc(sizeof(v2x_msg__msg__VehicleID__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  v2x_msg__msg__VehicleID__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    v2x_msg__msg__VehicleID * data =
      (v2x_msg__msg__VehicleID *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!v2x_msg__msg__VehicleID__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          v2x_msg__msg__VehicleID__fini(&data[i]);
        }
        free(data);
        return false;
      }
