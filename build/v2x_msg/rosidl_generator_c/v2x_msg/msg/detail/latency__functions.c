...
{
  v2x_msg__msg__Latency * msg = (v2x_msg__msg__Latency *)malloc(sizeof(v2x_msg__msg__Latency));
  if (!msg) {
    return NULL;
  }
...
v2x_msg__msg__Latency__Sequence__init(v2x_msg__msg__Latency__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (v2x_msg__msg__Latency *)calloc(size, sizeof(v2x_msg__msg__Latency));
    if (!data) {
      return false;
    }
...
{
  v2x_msg__msg__Latency__Sequence * array = (v2x_msg__msg__Latency__Sequence *)malloc(sizeof(v2x_msg__msg__Latency__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  v2x_msg__msg__Latency__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    v2x_msg__msg__Latency * data =
      (v2x_msg__msg__Latency *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!v2x_msg__msg__Latency__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          v2x_msg__msg__Latency__fini(&data[i]);
        }
        free(data);
        return false;
      }
