...
#include "v2x_msg/msg/detail/path_history_point__rosidl_typesupport_fastrtps_c.h"
...
using _PathHistoryPoint__ros_msg_type = v2x_msg__msg__PathHistoryPoint;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: latoffset
  {
    cdr << ros_message->latoffset;
  }

  // Field name: lonoffset
  {
    cdr << ros_message->lonoffset;
  }

  // Field name: elevationoffset
  {
...
static uint32_t _PathHistoryPoint__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_v2x_msg__msg__PathHistoryPoint(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = v2x_msg__msg__PathHistoryPoint;
    is_plain =
      (
...
static size_t _PathHistoryPoint__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_v2x_msg__msg__PathHistoryPoint(
