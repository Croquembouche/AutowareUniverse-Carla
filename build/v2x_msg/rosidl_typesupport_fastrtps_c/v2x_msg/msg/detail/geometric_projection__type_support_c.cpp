...
#include "v2x_msg/msg/detail/geometric_projection__rosidl_typesupport_fastrtps_c.h"
...
#include "v2x_msg/msg/detail/circle__functions.h"  // circle
...
using _GeometricProjection__ros_msg_type = v2x_msg__msg__GeometricProjection;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _GeometricProjection__ros_msg_type * ros_message = static_cast<const _GeometricProjection__ros_msg_type *>(untyped_ros_message);
  ...
  void * untyped_ros_message)
{
  ...
  _GeometricProjection__ros_msg_type * ros_message = static_cast<_GeometricProjection__ros_msg_type *>(untyped_ros_message);
  // Field name: direction
  {
    std::string tmp;
    cdr >> tmp;
...
static uint32_t _GeometricProjection__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_v2x_msg__msg__GeometricProjection(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = v2x_msg__msg__GeometricProjection;
    is_plain =
      (
...
static size_t _GeometricProjection__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_v2x_msg__msg__GeometricProjection(
...
static message_type_support_callbacks_t __callbacks_GeometricProjection = {
  "v2x_msg::msg",
  "GeometricProjection",
...
static rosidl_message_type_support_t _GeometricProjection__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_GeometricProjection,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, v2x_msg, msg, GeometricProjection)() {
  return &_GeometricProjection__type_support;
}
