...
#include "v2x_msg/msg/detail/acceleration_set4_way__rosidl_typesupport_fastrtps_c.h"
...
using _AccelerationSet4Way__ros_msg_type = v2x_msg__msg__AccelerationSet4Way;
...
static uint32_t _AccelerationSet4Way__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_v2x_msg__msg__AccelerationSet4Way(
...
static size_t _AccelerationSet4Way__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_v2x_msg__msg__AccelerationSet4Way(
