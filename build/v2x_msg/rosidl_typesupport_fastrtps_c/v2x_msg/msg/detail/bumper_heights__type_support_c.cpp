...
#include "v2x_msg/msg/detail/bumper_heights__rosidl_typesupport_fastrtps_c.h"
...
using _BumperHeights__ros_msg_type = v2x_msg__msg__BumperHeights;
...
static uint32_t _BumperHeights__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_v2x_msg__msg__BumperHeights(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = v2x_msg__msg__BumperHeights;
    is_plain =
      (
...
static size_t _BumperHeights__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_v2x_msg__msg__BumperHeights(
