...
#include "v2x_msg/msg/detail/vehicle_status_request__rosidl_typesupport_fastrtps_c.h"
...
using _VehicleStatusRequest__ros_msg_type = v2x_msg__msg__VehicleStatusRequest;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _VehicleStatusRequest__ros_msg_type * ros_message = static_cast<const _VehicleStatusRequest__ros_msg_type *>(untyped_ros_message);
  // Field name: datatype
  {
  ...
  // Field name: sendonlessthenvalue
  {
    cdr << ros_message->sendonlessthenvalue;
  }

  // Field name: sendonmorethenvalue
  {
  ...
  void * untyped_ros_message)
{
  ...
  _VehicleStatusRequest__ros_msg_type * ros_message = static_cast<_VehicleStatusRequest__ros_msg_type *>(untyped_ros_message);
  // Field name: datatype
  {
    cdr >> ros_message->datatype;
  }
...
static uint32_t _VehicleStatusRequest__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_v2x_msg__msg__VehicleStatusRequest(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = v2x_msg__msg__VehicleStatusRequest;
    is_plain =
      (
      offsetof(DataType, sendall) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _VehicleStatusRequest__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_v2x_msg__msg__VehicleStatusRequest(
...
static message_type_support_callbacks_t __callbacks_VehicleStatusRequest = {
  "v2x_msg::msg",
...
static rosidl_message_type_support_t _VehicleStatusRequest__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_VehicleStatusRequest,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, v2x_msg, msg, VehicleStatusRequest)() {
  return &_VehicleStatusRequest__type_support;
}
