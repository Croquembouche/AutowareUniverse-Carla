...
#include "v2x_msg/msg/detail/node_xy24b__rosidl_typesupport_fastrtps_c.h"
...
using _NodeXY24b__ros_msg_type = v2x_msg__msg__NodeXY24b;
...
static uint32_t _NodeXY24b__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_v2x_msg__msg__NodeXY24b(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = v2x_msg__msg__NodeXY24b;
    is_plain =
      (
      offsetof(DataType, y) +
      last_member_size
...
static size_t _NodeXY24b__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_v2x_msg__msg__NodeXY24b(
