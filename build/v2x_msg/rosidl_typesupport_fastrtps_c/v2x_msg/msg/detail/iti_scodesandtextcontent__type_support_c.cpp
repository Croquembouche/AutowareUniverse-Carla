...
#include "v2x_msg/msg/detail/iti_scodesandtextcontent__rosidl_typesupport_fastrtps_c.h"
...
using _ITIScodesandtextcontent__ros_msg_type = v2x_msg__msg__ITIScodesandtextcontent;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ITIScodesandtextcontent__ros_msg_type * ros_message = static_cast<const _ITIScodesandtextcontent__ros_msg_type *>(untyped_ros_message);
  // Field name: itis
  {
  ...
  void * untyped_ros_message)
{
  ...
  _ITIScodesandtextcontent__ros_msg_type * ros_message = static_cast<_ITIScodesandtextcontent__ros_msg_type *>(untyped_ros_message);
  // Field name: itis
  {
    cdr >> ros_message->itis;
  }
...
static uint32_t _ITIScodesandtextcontent__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_v2x_msg__msg__ITIScodesandtextcontent(
...
static size_t _ITIScodesandtextcontent__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_v2x_msg__msg__ITIScodesandtextcontent(
...
static message_type_support_callbacks_t __callbacks_ITIScodesandtextcontent = {
  "v2x_msg::msg",
...
static rosidl_message_type_support_t _ITIScodesandtextcontent__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ITIScodesandtextcontent,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, v2x_msg, msg, ITIScodesandtextcontent)() {
  return &_ITIScodesandtextcontent__type_support;
}
