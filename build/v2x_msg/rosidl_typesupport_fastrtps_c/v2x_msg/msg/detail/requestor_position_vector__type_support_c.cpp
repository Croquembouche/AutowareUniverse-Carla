...
#include "v2x_msg/msg/detail/requestor_position_vector__rosidl_typesupport_fastrtps_c.h"
...
using _RequestorPositionVector__ros_msg_type = v2x_msg__msg__RequestorPositionVector;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _RequestorPositionVector__ros_msg_type * ros_message = static_cast<const _RequestorPositionVector__ros_msg_type *>(untyped_ros_message);
  // Field name: position
  {
  ...
  void * untyped_ros_message)
{
  ...
  _RequestorPositionVector__ros_msg_type * ros_message = static_cast<_RequestorPositionVector__ros_msg_type *>(untyped_ros_message);
  // Field name: position
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _RequestorPositionVector__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_v2x_msg__msg__RequestorPositionVector(
...
static size_t _RequestorPositionVector__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_v2x_msg__msg__RequestorPositionVector(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_RequestorPositionVector = {
  "v2x_msg::msg",
...
static rosidl_message_type_support_t _RequestorPositionVector__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_RequestorPositionVector,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, v2x_msg, msg, RequestorPositionVector)() {
  return &_RequestorPositionVector__type_support;
}
