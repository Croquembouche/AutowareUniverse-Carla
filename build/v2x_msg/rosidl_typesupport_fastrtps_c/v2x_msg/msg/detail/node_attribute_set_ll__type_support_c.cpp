...
#include "v2x_msg/msg/detail/node_attribute_set_ll__rosidl_typesupport_fastrtps_c.h"
...
using _NodeAttributeSetLL__ros_msg_type = v2x_msg__msg__NodeAttributeSetLL;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _NodeAttributeSetLL__ros_msg_type * ros_message = static_cast<const _NodeAttributeSetLL__ros_msg_type *>(untyped_ros_message);
  ...
  void * untyped_ros_message)
{
  ...
  _NodeAttributeSetLL__ros_msg_type * ros_message = static_cast<_NodeAttributeSetLL__ros_msg_type *>(untyped_ros_message);
  // Field name: localnode
  {
    uint32_t cdrSize;
    cdr >> cdrSize;
...
static uint32_t _NodeAttributeSetLL__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_v2x_msg__msg__NodeAttributeSetLL(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = v2x_msg__msg__NodeAttributeSetLL;
    is_plain =
      (
      offsetof(DataType, delevation) +
      last_member_size
      ) == ret_val;
  }
...
static message_type_support_callbacks_t __callbacks_NodeAttributeSetLL = {
  "v2x_msg::msg",
  "NodeAttributeSetLL",
...
static rosidl_message_type_support_t _NodeAttributeSetLL__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_NodeAttributeSetLL,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, v2x_msg, msg, NodeAttributeSetLL)() {
  return &_NodeAttributeSetLL__type_support;
}
