...
#include "v2x_msg/msg/detail/itis_speed_limitcontent__rosidl_typesupport_fastrtps_c.h"
...
using _ITISSpeedLimitcontent__ros_msg_type = v2x_msg__msg__ITISSpeedLimitcontent;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ITISSpeedLimitcontent__ros_msg_type * ros_message = static_cast<const _ITISSpeedLimitcontent__ros_msg_type *>(untyped_ros_message);
  // Field name: itis
  {
  ...
  void * untyped_ros_message)
{
  ...
  _ITISSpeedLimitcontent__ros_msg_type * ros_message = static_cast<_ITISSpeedLimitcontent__ros_msg_type *>(untyped_ros_message);
  // Field name: itis
  {
    cdr >> ros_message->itis;
  }
...
static uint32_t _ITISSpeedLimitcontent__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_v2x_msg__msg__ITISSpeedLimitcontent(
...
static size_t _ITISSpeedLimitcontent__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_v2x_msg__msg__ITISSpeedLimitcontent(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_ITISSpeedLimitcontent = {
  "v2x_msg::msg",
...
static rosidl_message_type_support_t _ITISSpeedLimitcontent__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ITISSpeedLimitcontent,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, v2x_msg, msg, ITISSpeedLimitcontent)() {
  return &_ITISSpeedLimitcontent__type_support;
}
