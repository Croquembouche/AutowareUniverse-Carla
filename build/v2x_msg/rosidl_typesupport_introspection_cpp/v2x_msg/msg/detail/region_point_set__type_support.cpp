...
void fetch_function__RegionPointSet__nodelist(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const v2x_msg::msg::RegionOffsets *>(
    get_const_function__RegionPointSet__nodelist(untyped_member, index));
  auto & value = *reinterpret_cast<v2x_msg::msg::RegionOffsets *>(untyped_value);
  value = item;
}

void assign_function__RegionPointSet__nodelist(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<v2x_msg::msg::RegionOffsets *>(
    get_function__RegionPointSet__nodelist(untyped_member, index));
  const auto & value = *reinterpret_cast<const v2x_msg::msg::RegionOffsets *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember RegionPointSet_message_member_array[3] = {
  ...
  },
  {
    ...
    fetch_function__RegionPointSet__nodelist,  // fetch(index, &value) function pointer
    assign_function__RegionPointSet__nodelist,  // assign(index, value) function pointer
