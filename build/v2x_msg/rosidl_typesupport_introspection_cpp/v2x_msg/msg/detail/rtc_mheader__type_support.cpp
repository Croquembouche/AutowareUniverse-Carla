...
{
  new (message_memory) v2x_msg::msg::RTCMheader(_init);
}

void RTCMheader_fini_function(void * message_memory)
{
  auto typed_message = static_cast<v2x_msg::msg::RTCMheader *>(message_memory);
  typed_message->~RTCMheader();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember RTCMheader_message_member_array[2] = {
  {
    "status",  // name
    ...
    offsetof(v2x_msg::msg::RTCMheader, status),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<v2x_msg::msg::AntennaOffsetSet>(),  // members of sub message
    false,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(v2x_msg::msg::RTCMheader, offsetset),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
{
  return &::v2x_msg::msg::rosidl_typesupport_introspection_cpp::RTCMheader_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, v2x_msg, msg, RTCMheader)() {
  return &::v2x_msg::msg::rosidl_typesupport_introspection_cpp::RTCMheader_message_type_support_handle;
}
