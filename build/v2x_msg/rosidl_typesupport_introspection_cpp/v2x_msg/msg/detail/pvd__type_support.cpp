...
void fetch_function__PVD__snapshots(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const v2x_msg::msg::Snapshot *>(
    get_const_function__PVD__snapshots(untyped_member, index));
  auto & value = *reinterpret_cast<v2x_msg::msg::Snapshot *>(untyped_value);
  value = item;
}

void assign_function__PVD__snapshots(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<v2x_msg::msg::Snapshot *>(
    get_function__PVD__snapshots(untyped_member, index));
  const auto & value = *reinterpret_cast<const v2x_msg::msg::Snapshot *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember PVD_message_member_array[6] = {
  ...
  },
  {
    ...
    fetch_function__PVD__snapshots,  // fetch(index, &value) function pointer
    assign_function__PVD__snapshots,  // assign(index, value) function pointer
