...
{
  new (message_memory) v2x_msg::msg::WiperSet(_init);
}

void WiperSet_fini_function(void * message_memory)
{
  auto typed_message = static_cast<v2x_msg::msg::WiperSet *>(message_memory);
  typed_message->~WiperSet();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember WiperSet_message_member_array[4] = {
  {
    "statusfront",  // name
    ...
    offsetof(v2x_msg::msg::WiperSet, statusfront),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(v2x_msg::msg::WiperSet, ratefront),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(v2x_msg::msg::WiperSet, statusrear),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(v2x_msg::msg::WiperSet, raterear),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
{
  return &::v2x_msg::msg::rosidl_typesupport_introspection_cpp::WiperSet_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, v2x_msg, msg, WiperSet)() {
  return &::v2x_msg::msg::rosidl_typesupport_introspection_cpp::WiperSet_message_type_support_handle;
}
