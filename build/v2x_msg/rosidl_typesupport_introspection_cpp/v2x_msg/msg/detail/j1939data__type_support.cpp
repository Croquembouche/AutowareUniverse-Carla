...
void fetch_function__J1939data__tires(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const v2x_msg::msg::TireData *>(
    get_const_function__J1939data__tires(untyped_member, index));
  auto & value = *reinterpret_cast<v2x_msg::msg::TireData *>(untyped_value);
  value = item;
}

void assign_function__J1939data__tires(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<v2x_msg::msg::TireData *>(
    get_function__J1939data__tires(untyped_member, index));
  const auto & value = *reinterpret_cast<const v2x_msg::msg::TireData *>(untyped_value);
  item = value;
}
...
void fetch_function__J1939data__axles(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const v2x_msg::msg::AxleWeight *>(
    get_const_function__J1939data__axles(untyped_member, index));
  auto & value = *reinterpret_cast<v2x_msg::msg::AxleWeight *>(untyped_value);
  value = item;
}

void assign_function__J1939data__axles(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<v2x_msg::msg::AxleWeight *>(
    get_function__J1939data__axles(untyped_member, index));
  const auto & value = *reinterpret_cast<const v2x_msg::msg::AxleWeight *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember J1939data_message_member_array[10] = {
  {
    ...
    fetch_function__J1939data__tires,  // fetch(index, &value) function pointer
    assign_function__J1939data__tires,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__J1939data__axles,  // fetch(index, &value) function pointer
    assign_function__J1939data__axles,  // assign(index, value) function pointer
