...
void fetch_function__ITISSpeedLimit__item(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const v2x_msg::msg::ITISSpeedLimitcontent *>(
    get_const_function__ITISSpeedLimit__item(untyped_member, index));
  auto & value = *reinterpret_cast<v2x_msg::msg::ITISSpeedLimitcontent *>(untyped_value);
  value = item;
}

void assign_function__ITISSpeedLimit__item(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<v2x_msg::msg::ITISSpeedLimitcontent *>(
    get_function__ITISSpeedLimit__item(untyped_member, index));
  const auto & value = *reinterpret_cast<const v2x_msg::msg::ITISSpeedLimitcontent *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ITISSpeedLimit_message_member_array[1] = {
  {
    ...
    fetch_function__ITISSpeedLimit__item,  // fetch(index, &value) function pointer
    assign_function__ITISSpeedLimit__item,  // assign(index, value) function pointer
