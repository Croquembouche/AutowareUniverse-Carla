...
void fetch_function__SSM__status(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const v2x_msg::msg::SignalStatus *>(
    get_const_function__SSM__status(untyped_member, index));
  auto & value = *reinterpret_cast<v2x_msg::msg::SignalStatus *>(untyped_value);
  value = item;
}

void assign_function__SSM__status(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<v2x_msg::msg::SignalStatus *>(
    get_function__SSM__status(untyped_member, index));
  const auto & value = *reinterpret_cast<const v2x_msg::msg::SignalStatus *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SSM_message_member_array[4] = {
  ...
  },
  {
    ...
    fetch_function__SSM__status,  // fetch(index, &value) function pointer
    assign_function__SSM__status,  // assign(index, value) function pointer
