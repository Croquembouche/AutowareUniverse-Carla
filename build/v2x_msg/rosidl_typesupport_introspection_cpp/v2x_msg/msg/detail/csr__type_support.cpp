...
void fetch_function__CSR__requests(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const v2x_msg::msg::RequestedItem *>(
    get_const_function__CSR__requests(untyped_member, index));
  auto & value = *reinterpret_cast<v2x_msg::msg::RequestedItem *>(untyped_value);
  value = item;
}

void assign_function__CSR__requests(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<v2x_msg::msg::RequestedItem *>(
    get_function__CSR__requests(untyped_member, index));
  const auto & value = *reinterpret_cast<const v2x_msg::msg::RequestedItem *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember CSR_message_member_array[4] = {
  ...
  },
  {
    ...
    fetch_function__CSR__requests,  // fetch(index, &value) function pointer
    assign_function__CSR__requests,  // assign(index, value) function pointer
