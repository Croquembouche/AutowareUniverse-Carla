...
{
  new (message_memory) v2x_msg::msg::SpeedLimit(_init);
}

void SpeedLimit_fini_function(void * message_memory)
{
  auto typed_message = static_cast<v2x_msg::msg::SpeedLimit *>(message_memory);
  typed_message->~SpeedLimit();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember SpeedLimit_message_member_array[2] = {
  {
    "type",  // name
    ...
    offsetof(v2x_msg::msg::SpeedLimit, type),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(v2x_msg::msg::SpeedLimit, speed),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
get_message_type_support_handle<v2x_msg::msg::SpeedLimit>()
{
  return &::v2x_msg::msg::rosidl_typesupport_introspection_cpp::SpeedLimit_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, v2x_msg, msg, SpeedLimit)() {
  return &::v2x_msg::msg::rosidl_typesupport_introspection_cpp::SpeedLimit_message_type_support_handle;
}
