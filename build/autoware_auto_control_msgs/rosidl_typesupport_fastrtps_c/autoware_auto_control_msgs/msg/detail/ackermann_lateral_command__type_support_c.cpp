  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_auto_control_msgs__msg__AckermannLateralCommand;
    is_plain =
      (
...
static size_t _AckermannLateralCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_autoware_auto_control_msgs__msg__AckermannLateralCommand(
