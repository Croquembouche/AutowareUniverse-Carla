...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, autoware_auto_planning_msgs, action, PlanTrajectory_SendGoal)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<autoware_auto_planning_msgs::action::PlanTrajectory_SendGoal>();
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, autoware_auto_planning_msgs, action, PlanTrajectory_GetResult)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<autoware_auto_planning_msgs::action::PlanTrajectory_GetResult>();
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_action_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__ACTION_SYMBOL_NAME(rosidl_typesupport_cpp, autoware_auto_planning_msgs, action, PlanTrajectory)() {
  return ::rosidl_typesupport_cpp::get_action_type_support_handle<autoware_auto_planning_msgs::action::PlanTrajectory>();
}
