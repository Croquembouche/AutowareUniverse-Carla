...
bool autoware_auto_geometry_msgs__msg__quaternion32__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("autoware_auto_geometry_msgs.msg._quaternion32.Quaternion32", full_classname_dest, 58) == 0);
  }
  autoware_auto_geometry_msgs__msg__Quaternion32 * ros_message = _ros_message;
  {  // x
...
PyObject * autoware_auto_geometry_msgs__msg__quaternion32__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("autoware_auto_geometry_msgs.msg._quaternion32");
