...
static const ::rosidl_typesupport_introspection_cpp::MessageMember HADMapSegment_message_member_array[2] = {
  {
    ...
    fetch_function__HADMapSegment__primitives,  // fetch(index, &value) function pointer
    assign_function__HADMapSegment__primitives,  // assign(index, value) function pointer
