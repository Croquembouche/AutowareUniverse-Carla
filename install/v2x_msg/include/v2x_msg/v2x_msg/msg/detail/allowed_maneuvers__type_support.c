...
void v2x_msg__msg__AllowedManeuvers__rosidl_typesupport_introspection_c__AllowedManeuvers_init_function(
...
void v2x_msg__msg__AllowedManeuvers__rosidl_typesupport_introspection_c__AllowedManeuvers_fini_function(void * message_memory)
{
  v2x_msg__msg__AllowedManeuvers__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember v2x_msg__msg__AllowedManeuvers__rosidl_typesupport_introspection_c__AllowedManeuvers_message_member_array[12] = {
  {
...
static const rosidl_typesupport_introspection_c__MessageMembers v2x_msg__msg__AllowedManeuvers__rosidl_typesupport_introspection_c__AllowedManeuvers_message_members = {
  "v2x_msg__msg",  // message namespace
  "AllowedManeuvers",  // message name
  12,  // number of fields
  sizeof(v2x_msg__msg__AllowedManeuvers),
  v2x_msg__msg__AllowedManeuvers__rosidl_typesupport_introspection_c__AllowedManeuvers_message_member_array,  // message members
  v2x_msg__msg__AllowedManeuvers__rosidl_typesupport_introspection_c__AllowedManeuvers_init_function,  // function to initialize message memory (memory has to be allocated)
  v2x_msg__msg__AllowedManeuvers__rosidl_typesupport_introspection_c__AllowedManeuvers_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t v2x_msg__msg__AllowedManeuvers__rosidl_typesupport_introspection_c__AllowedManeuvers_message_type_support_handle = {
  0,
  &v2x_msg__msg__AllowedManeuvers__rosidl_typesupport_introspection_c__AllowedManeuvers_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, v2x_msg, msg, AllowedManeuvers)() {
  if (!v2x_msg__msg__AllowedManeuvers__rosidl_typesupport_introspection_c__AllowedManeuvers_message_type_support_handle.typesupport_identifier) {
    v2x_msg__msg__AllowedManeuvers__rosidl_typesupport_introspection_c__AllowedManeuvers_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &v2x_msg__msg__AllowedManeuvers__rosidl_typesupport_introspection_c__AllowedManeuvers_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
