...
{
  new (message_memory) v2x_msg::msg::NodeXY28b(_init);
}

void NodeXY28b_fini_function(void * message_memory)
{
  auto typed_message = static_cast<v2x_msg::msg::NodeXY28b *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember NodeXY28b_message_member_array[2] = {
  {
    ...
    offsetof(v2x_msg::msg::NodeXY28b, x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(v2x_msg::msg::NodeXY28b, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
{
  return &::v2x_msg::msg::rosidl_typesupport_introspection_cpp::NodeXY28b_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, v2x_msg, msg, NodeXY28b)() {
  return &::v2x_msg::msg::rosidl_typesupport_introspection_cpp::NodeXY28b_message_type_support_handle;
}
