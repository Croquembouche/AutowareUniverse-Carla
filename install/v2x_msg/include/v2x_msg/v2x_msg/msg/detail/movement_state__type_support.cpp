...
void fetch_function__MovementState__statetimespeed(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const v2x_msg::msg::MovementEvent *>(
    get_const_function__MovementState__statetimespeed(untyped_member, index));
  auto & value = *reinterpret_cast<v2x_msg::msg::MovementEvent *>(untyped_value);
  value = item;
}

void assign_function__MovementState__statetimespeed(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<v2x_msg::msg::MovementEvent *>(
    get_function__MovementState__statetimespeed(untyped_member, index));
  const auto & value = *reinterpret_cast<const v2x_msg::msg::MovementEvent *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MovementState_message_member_array[4] = {
  ...
  },
  {
    ...
    fetch_function__MovementState__statetimespeed,  // fetch(index, &value) function pointer
    assign_function__MovementState__statetimespeed,  // assign(index, value) function pointer
