...
{
  v2x_msg__msg__BumperHeights * msg = (v2x_msg__msg__BumperHeights *)malloc(sizeof(v2x_msg__msg__BumperHeights));
  if (!msg) {
    return NULL;
  }
...
v2x_msg__msg__BumperHeights__Sequence__init(v2x_msg__msg__BumperHeights__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (v2x_msg__msg__BumperHeights *)calloc(size, sizeof(v2x_msg__msg__BumperHeights));
    if (!data) {
      return false;
    }
...
{
  v2x_msg__msg__BumperHeights__Sequence * array = (v2x_msg__msg__BumperHeights__Sequence *)malloc(sizeof(v2x_msg__msg__BumperHeights__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  v2x_msg__msg__BumperHeights__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    v2x_msg__msg__BumperHeights * data =
      (v2x_msg__msg__BumperHeights *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!v2x_msg__msg__BumperHeights__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          v2x_msg__msg__BumperHeights__fini(&data[i]);
        }
        free(data);
        return false;
      }
