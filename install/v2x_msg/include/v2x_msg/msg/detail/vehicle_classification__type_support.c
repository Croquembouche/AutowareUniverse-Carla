...
static rosidl_typesupport_introspection_c__MessageMember VehicleClassification__rosidl_typesupport_introspection_c__VehicleClassification_message_member_array[8] = {
  {
    "keytype",  // name
