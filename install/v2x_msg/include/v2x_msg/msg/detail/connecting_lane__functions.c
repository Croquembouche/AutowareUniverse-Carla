...
{
  v2x_msg__msg__ConnectingLane * msg = (v2x_msg__msg__ConnectingLane *)malloc(sizeof(v2x_msg__msg__ConnectingLane));
  if (!msg) {
    return NULL;
  }
...
v2x_msg__msg__ConnectingLane__Sequence__init(v2x_msg__msg__ConnectingLane__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (v2x_msg__msg__ConnectingLane *)calloc(size, sizeof(v2x_msg__msg__ConnectingLane));
    if (!data) {
      return false;
    }
...
{
  v2x_msg__msg__ConnectingLane__Sequence * array = (v2x_msg__msg__ConnectingLane__Sequence *)malloc(sizeof(v2x_msg__msg__ConnectingLane__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  v2x_msg__msg__ConnectingLane__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    v2x_msg__msg__ConnectingLane * data =
      (v2x_msg__msg__ConnectingLane *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!v2x_msg__msg__ConnectingLane__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          v2x_msg__msg__ConnectingLane__fini(&data[i]);
        }
        free(data);
        return false;
      }
