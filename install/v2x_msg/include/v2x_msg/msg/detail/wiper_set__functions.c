...
{
  v2x_msg__msg__WiperSet * msg = (v2x_msg__msg__WiperSet *)malloc(sizeof(v2x_msg__msg__WiperSet));
  if (!msg) {
    return NULL;
  }
...
v2x_msg__msg__WiperSet__Sequence__init(v2x_msg__msg__WiperSet__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (v2x_msg__msg__WiperSet *)calloc(size, sizeof(v2x_msg__msg__WiperSet));
    if (!data) {
      return false;
    }
...
{
  v2x_msg__msg__WiperSet__Sequence * array = (v2x_msg__msg__WiperSet__Sequence *)malloc(sizeof(v2x_msg__msg__WiperSet__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  v2x_msg__msg__WiperSet__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    v2x_msg__msg__WiperSet * data =
      (v2x_msg__msg__WiperSet *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!v2x_msg__msg__WiperSet__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          v2x_msg__msg__WiperSet__fini(&data[i]);
        }
        free(data);
        return false;
      }
