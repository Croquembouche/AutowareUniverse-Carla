...
{
  v2x_msg__msg__VehicleStatus * msg = (v2x_msg__msg__VehicleStatus *)malloc(sizeof(v2x_msg__msg__VehicleStatus));
  if (!msg) {
    return NULL;
  }
...
v2x_msg__msg__VehicleStatus__Sequence__init(v2x_msg__msg__VehicleStatus__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (v2x_msg__msg__VehicleStatus *)calloc(size, sizeof(v2x_msg__msg__VehicleStatus));
    if (!data) {
      return false;
    }
...
{
  v2x_msg__msg__VehicleStatus__Sequence * array = (v2x_msg__msg__VehicleStatus__Sequence *)malloc(sizeof(v2x_msg__msg__VehicleStatus__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  v2x_msg__msg__VehicleStatus__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    v2x_msg__msg__VehicleStatus * data =
      (v2x_msg__msg__VehicleStatus *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!v2x_msg__msg__VehicleStatus__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          v2x_msg__msg__VehicleStatus__fini(&data[i]);
        }
        free(data);
        return false;
      }
