...
{
  v2x_msg__msg__IntersectionReferenceID * msg = (v2x_msg__msg__IntersectionReferenceID *)malloc(sizeof(v2x_msg__msg__IntersectionReferenceID));
  if (!msg) {
    return NULL;
  }
...
v2x_msg__msg__IntersectionReferenceID__Sequence__init(v2x_msg__msg__IntersectionReferenceID__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (v2x_msg__msg__IntersectionReferenceID *)calloc(size, sizeof(v2x_msg__msg__IntersectionReferenceID));
    if (!data) {
      return false;
    }
...
{
  v2x_msg__msg__IntersectionReferenceID__Sequence * array = (v2x_msg__msg__IntersectionReferenceID__Sequence *)malloc(sizeof(v2x_msg__msg__IntersectionReferenceID__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  v2x_msg__msg__IntersectionReferenceID__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    v2x_msg__msg__IntersectionReferenceID * data =
      (v2x_msg__msg__IntersectionReferenceID *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!v2x_msg__msg__IntersectionReferenceID__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          v2x_msg__msg__IntersectionReferenceID__fini(&data[i]);
        }
        free(data);
        return false;
      }
