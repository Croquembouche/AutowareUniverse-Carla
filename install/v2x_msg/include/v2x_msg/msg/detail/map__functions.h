...
#ifndef V2X_MSG__MSG__DETAIL__MAP__FUNCTIONS_H_
#define V2X_MSG__MSG__DETAIL__MAP__FUNCTIONS_H_
 ...
 * v2x_msg__msg__MAP__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * v2x_msg__msg__MAP__Sequence__fini()
 * on the array,
...
#endif  // V2X_MSG__MSG__DETAIL__MAP__FUNCTIONS_H_
