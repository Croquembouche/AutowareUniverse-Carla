...
{
  v2x_msg__msg__IntersectionState * msg = (v2x_msg__msg__IntersectionState *)malloc(sizeof(v2x_msg__msg__IntersectionState));
  if (!msg) {
    return NULL;
  }
...
v2x_msg__msg__IntersectionState__Sequence__init(v2x_msg__msg__IntersectionState__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (v2x_msg__msg__IntersectionState *)calloc(size, sizeof(v2x_msg__msg__IntersectionState));
    if (!data) {
      return false;
    }
...
{
  v2x_msg__msg__IntersectionState__Sequence * array = (v2x_msg__msg__IntersectionState__Sequence *)malloc(sizeof(v2x_msg__msg__IntersectionState__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  v2x_msg__msg__IntersectionState__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    v2x_msg__msg__IntersectionState * data =
      (v2x_msg__msg__IntersectionState *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!v2x_msg__msg__IntersectionState__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          v2x_msg__msg__IntersectionState__fini(&data[i]);
        }
        free(data);
        return false;
      }
