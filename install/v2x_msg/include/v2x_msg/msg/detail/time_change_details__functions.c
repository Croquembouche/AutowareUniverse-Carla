...
{
  v2x_msg__msg__TimeChangeDetails * msg = (v2x_msg__msg__TimeChangeDetails *)malloc(sizeof(v2x_msg__msg__TimeChangeDetails));
  if (!msg) {
    return NULL;
  }
...
v2x_msg__msg__TimeChangeDetails__Sequence__init(v2x_msg__msg__TimeChangeDetails__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (v2x_msg__msg__TimeChangeDetails *)calloc(size, sizeof(v2x_msg__msg__TimeChangeDetails));
    if (!data) {
      return false;
    }
...
{
  v2x_msg__msg__TimeChangeDetails__Sequence * array = (v2x_msg__msg__TimeChangeDetails__Sequence *)malloc(sizeof(v2x_msg__msg__TimeChangeDetails__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  v2x_msg__msg__TimeChangeDetails__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    v2x_msg__msg__TimeChangeDetails * data =
      (v2x_msg__msg__TimeChangeDetails *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!v2x_msg__msg__TimeChangeDetails__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          v2x_msg__msg__TimeChangeDetails__fini(&data[i]);
        }
        free(data);
        return false;
      }
