...
class PositionalAccuracy(metaclass=Metaclass_PositionalAccuracy):
    ...
    def __init__(self, **kwargs):
        ...
        self.semimajor = kwargs.get('semimajor', int())
        self.semiminor = kwargs.get('semiminor', int())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.semimajor != other.semimajor:
            return False
        if self.semiminor != other.semiminor:
            return False
    ...
    def semimajor(self, value):
        if __debug__:
            assert \
                ...
                "The 'semimajor' field must be of type 'int'"
    ...
    def semiminor(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'semiminor' field must be of type 'int'"
            assert value >= -9223372036854775808 and value < 9223372036854775808, \
    ...
    def orientation(self, value):
        if __debug__:
            ...
            assert value >= -9223372036854775808 and value < 9223372036854775808, \
                "The 'orientation' field must be an integer in [-9223372036854775808, 9223372036854775807]"
