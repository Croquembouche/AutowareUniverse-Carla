...
bool v2x_msg__msg__speed_limit__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("v2x_msg.msg._speed_limit.SpeedLimit", full_classname_dest, 35) == 0);
  }
  v2x_msg__msg__SpeedLimit * ros_message = _ros_message;
  {  // type
...
PyObject * v2x_msg__msg__speed_limit__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("v2x_msg.msg._speed_limit");
