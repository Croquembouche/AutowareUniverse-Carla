...
bool v2x_msg__msg__axle_weight__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("v2x_msg.msg._axle_weight.AxleWeight", full_classname_dest, 35) == 0);
  }
  v2x_msg__msg__AxleWeight * ros_message = _ros_message;
  {  // location
  ...
  {  // weight
    ...
    assert(PyLong_Check(field));
    ros_message->weight = PyLong_AsLongLong(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of AxleWeight */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("v2x_msg.msg._axle_weight");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AxleWeight");
  ...
  {  // weight
    PyObject * field = NULL;
    field = PyLong_FromLongLong(ros_message->weight);
    {
