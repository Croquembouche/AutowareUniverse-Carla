...
class LaneAttributes(metaclass=Metaclass_LaneAttributes):
    ...
    def __init__(self, **kwargs):
        ...
        self.directionaluse = kwargs.get('directionaluse', str())
        self.sharedwith = kwargs.get('sharedwith', str())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.directionaluse != other.directionaluse:
            return False
        if self.sharedwith != other.sharedwith:
            return False
    ...
    @directionaluse.setter
    def directionaluse(self, value):
        if __debug__:
            assert \
    ...
    def lanetype(self, value):
        if __debug__:
            ...
            assert value >= -9223372036854775808 and value < 9223372036854775808, \
                "The 'lanetype' field must be an integer in [-9223372036854775808, 9223372036854775807]"
