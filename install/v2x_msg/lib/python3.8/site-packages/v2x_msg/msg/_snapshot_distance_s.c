...
bool v2x_msg__msg__snapshot_distance__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("v2x_msg.msg._snapshot_distance.SnapshotDistance", full_classname_dest, 47) == 0);
  }
  v2x_msg__msg__SnapshotDistance * ros_message = _ros_message;
  {  // distance1
    ...
    ros_message->distance1 = PyLong_AsLongLong(field);
    Py_DECREF(field);
  }
  {  // speed1
  ...
  {  // distance2
    ...
    assert(PyLong_Check(field));
    ros_message->distance2 = PyLong_AsLongLong(field);
    Py_DECREF(field);
  }
  {  // speed2
...
{
  /* NOTE(esteve): Call constructor of SnapshotDistance */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("v2x_msg.msg._snapshot_distance");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SnapshotDistance");
  ...
  {  // distance1
    PyObject * field = NULL;
    field = PyLong_FromLongLong(ros_message->distance1);
    {
  ...
  {  // distance2
    PyObject * field = NULL;
    field = PyLong_FromLongLong(ros_message->distance2);
    {
