...
bool v2x_msg__msg__restriction_user_type__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("v2x_msg.msg._restriction_user_type.RestrictionUserType", full_classname_dest, 54) == 0);
  }
  v2x_msg__msg__RestrictionUserType * ros_message = _ros_message;
  {  // basictype
...
{
  /* NOTE(esteve): Call constructor of RestrictionUserType */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("v2x_msg.msg._restriction_user_type");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RestrictionUserType");
