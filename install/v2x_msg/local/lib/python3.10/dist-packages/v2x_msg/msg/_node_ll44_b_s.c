...
bool v2x_msg__msg__node_ll44_b__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("v2x_msg.msg._node_ll44_b.NodeLL44B", full_classname_dest, 34) == 0);
  }
  v2x_msg__msg__NodeLL44B * ros_message = _ros_message;
  {  // lon
...
{
  /* NOTE(esteve): Call constructor of NodeLL44B */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("v2x_msg.msg._node_ll44_b");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "NodeLL44B");
