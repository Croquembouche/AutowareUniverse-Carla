...
bool v2x_msg__msg__node_list_xy__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("v2x_msg.msg._node_list_xy.NodeListXY", full_classname_dest, 36) == 0);
  }
  v2x_msg__msg__NodeListXY * ros_message = _ros_message;
  {  // nodes
    ...
    if (!v2x_msg__msg__NodeXY__Sequence__init(&(ros_message->nodes), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create v2x_msg__msg__NodeXY__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    v2x_msg__msg__NodeXY * dest = ros_message->nodes.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!v2x_msg__msg__node_xy__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // computed
    ...
    if (!v2x_msg__msg__computed_lane__convert_from_py(field, &ros_message->computed)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * v2x_msg__msg__node_list_xy__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("v2x_msg.msg._node_list_xy");
  ...
  {  // nodes
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = v2x_msg__msg__node_xy__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
  ...
  {  // computed
    PyObject * field = NULL;
    field = v2x_msg__msg__computed_lane__convert_to_py(&ros_message->computed);
    if (!field) {
      return NULL;
    }
    {
