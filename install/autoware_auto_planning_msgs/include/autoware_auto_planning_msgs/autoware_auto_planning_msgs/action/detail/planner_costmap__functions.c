  ...
  autoware_auto_planning_msgs__action__PlannerCostmap_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    autoware_auto_planning_msgs__action__PlannerCostmap_Goal * data =
      (autoware_auto_planning_msgs__action__PlannerCostmap_Goal *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autoware_auto_planning_msgs__action__PlannerCostmap_Goal__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          autoware_auto_planning_msgs__action__PlannerCostmap_Goal__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  autoware_auto_planning_msgs__action__PlannerCostmap_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    autoware_auto_planning_msgs__action__PlannerCostmap_Result * data =
      (autoware_auto_planning_msgs__action__PlannerCostmap_Result *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autoware_auto_planning_msgs__action__PlannerCostmap_Result__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          autoware_auto_planning_msgs__action__PlannerCostmap_Result__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  autoware_auto_planning_msgs__action__PlannerCostmap_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    autoware_auto_planning_msgs__action__PlannerCostmap_Feedback * data =
      (autoware_auto_planning_msgs__action__PlannerCostmap_Feedback *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autoware_auto_planning_msgs__action__PlannerCostmap_Feedback__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          autoware_auto_planning_msgs__action__PlannerCostmap_Feedback__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  autoware_auto_planning_msgs__action__PlannerCostmap_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    autoware_auto_planning_msgs__action__PlannerCostmap_SendGoal_Request * data =
      (autoware_auto_planning_msgs__action__PlannerCostmap_SendGoal_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autoware_auto_planning_msgs__action__PlannerCostmap_SendGoal_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          autoware_auto_planning_msgs__action__PlannerCostmap_SendGoal_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  autoware_auto_planning_msgs__action__PlannerCostmap_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    autoware_auto_planning_msgs__action__PlannerCostmap_SendGoal_Response * data =
      (autoware_auto_planning_msgs__action__PlannerCostmap_SendGoal_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autoware_auto_planning_msgs__action__PlannerCostmap_SendGoal_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          autoware_auto_planning_msgs__action__PlannerCostmap_SendGoal_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  autoware_auto_planning_msgs__action__PlannerCostmap_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    autoware_auto_planning_msgs__action__PlannerCostmap_GetResult_Request * data =
      (autoware_auto_planning_msgs__action__PlannerCostmap_GetResult_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autoware_auto_planning_msgs__action__PlannerCostmap_GetResult_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          autoware_auto_planning_msgs__action__PlannerCostmap_GetResult_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  autoware_auto_planning_msgs__action__PlannerCostmap_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    autoware_auto_planning_msgs__action__PlannerCostmap_GetResult_Response * data =
      (autoware_auto_planning_msgs__action__PlannerCostmap_GetResult_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autoware_auto_planning_msgs__action__PlannerCostmap_GetResult_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          autoware_auto_planning_msgs__action__PlannerCostmap_GetResult_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  autoware_auto_planning_msgs__action__PlannerCostmap_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    autoware_auto_planning_msgs__action__PlannerCostmap_FeedbackMessage * data =
      (autoware_auto_planning_msgs__action__PlannerCostmap_FeedbackMessage *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autoware_auto_planning_msgs__action__PlannerCostmap_FeedbackMessage__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          autoware_auto_planning_msgs__action__PlannerCostmap_FeedbackMessage__fini(&output->data[i]);
        }
        return false;
      }
    }
