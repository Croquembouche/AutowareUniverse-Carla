...
#ifndef AUTOWARE_AUTO_PLANNING_MSGS__ACTION__PLAN_TRAJECTORY_H_
#define AUTOWARE_AUTO_PLANNING_MSGS__ACTION__PLAN_TRAJECTORY_H_
...
#endif  // AUTOWARE_AUTO_PLANNING_MSGS__ACTION__PLAN_TRAJECTORY_H_
