...
#ifndef AUTOWARE_AUTO_PLANNING_MSGS__SRV__MODIFY_TRAJECTORY_H_
#define AUTOWARE_AUTO_PLANNING_MSGS__SRV__MODIFY_TRAJECTORY_H_
...
#endif  // AUTOWARE_AUTO_PLANNING_MSGS__SRV__MODIFY_TRAJECTORY_H_
