...
bool autoware_auto_planning_msgs__msg__route__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("autoware_auto_planning_msgs.msg._route.Route", full_classname_dest, 44) == 0);
  }
  autoware_auto_planning_msgs__msg__Route * ros_message = _ros_message;
  {  // header
  ...
  {  // start_point
    ...
    if (!autoware_auto_planning_msgs__msg__trajectory_point__convert_from_py(field, &ros_message->start_point)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // goal_point
    ...
    if (!autoware_auto_planning_msgs__msg__trajectory_point__convert_from_py(field, &ros_message->goal_point)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * autoware_auto_planning_msgs__msg__route__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("autoware_auto_planning_msgs.msg._route");
  ...
  {  // start_point
    PyObject * field = NULL;
    field = autoware_auto_planning_msgs__msg__trajectory_point__convert_to_py(&ros_message->start_point);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // goal_point
    PyObject * field = NULL;
    field = autoware_auto_planning_msgs__msg__trajectory_point__convert_to_py(&ros_message->goal_point);
    if (!field) {
      return NULL;
    }
    {
