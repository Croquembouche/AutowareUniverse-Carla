...
{
  const auto & item = *reinterpret_cast<const autoware_auto_perception_msgs::msg::TrafficLightRoi *>(
    get_const_function__TrafficLightRoiArray__rois(untyped_member, index));
  auto & value = *reinterpret_cast<autoware_auto_perception_msgs::msg::TrafficLightRoi *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<autoware_auto_perception_msgs::msg::TrafficLightRoi *>(
    get_function__TrafficLightRoiArray__rois(untyped_member, index));
  const auto & value = *reinterpret_cast<const autoware_auto_perception_msgs::msg::TrafficLightRoi *>(untyped_value);
  item = value;
}
