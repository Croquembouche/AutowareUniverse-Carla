...
#ifndef AUTOWARE_AUTO_VEHICLE_MSGS__MSG__HORN_REPORT_H_
#define AUTOWARE_AUTO_VEHICLE_MSGS__MSG__HORN_REPORT_H_
...
#endif  // AUTOWARE_AUTO_VEHICLE_MSGS__MSG__HORN_REPORT_H_
