...
void fetch_function__SteeringFactorArray__factors(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const autoware_adapi_v1_msgs::msg::SteeringFactor *>(
    get_const_function__SteeringFactorArray__factors(untyped_member, index));
  auto & value = *reinterpret_cast<autoware_adapi_v1_msgs::msg::SteeringFactor *>(untyped_value);
  value = item;
}

void assign_function__SteeringFactorArray__factors(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<autoware_adapi_v1_msgs::msg::SteeringFactor *>(
    get_function__SteeringFactorArray__factors(untyped_member, index));
  const auto & value = *reinterpret_cast<const autoware_adapi_v1_msgs::msg::SteeringFactor *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SteeringFactorArray_message_member_array[2] = {
  ...
  },
  {
    ...
    fetch_function__SteeringFactorArray__factors,  // fetch(index, &value) function pointer
    assign_function__SteeringFactorArray__factors,  // assign(index, value) function pointer
